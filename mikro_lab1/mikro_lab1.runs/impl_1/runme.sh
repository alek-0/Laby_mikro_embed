...
HD_PWD='C:/Designs/komo/mikro_lab1/mikro_lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microprocessor_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microprocessor_block_wrapper.tcl -notrace
