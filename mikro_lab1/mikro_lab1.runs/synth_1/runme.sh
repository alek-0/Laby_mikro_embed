...
HD_PWD='C:/Designs/komo/mikro_lab1/mikro_lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microprocessor_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microprocessor_block_wrapper.tcl
