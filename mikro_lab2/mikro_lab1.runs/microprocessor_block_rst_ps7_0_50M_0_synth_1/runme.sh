...
HD_PWD='C:/Designs/komo/mikro_lab1/mikro_lab1.runs/microprocessor_block_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microprocessor_block_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microprocessor_block_rst_ps7_0_50M_0.tcl
